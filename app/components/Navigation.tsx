...
import MembershipMegaMenu from './MembershipMegaMenu';
...
export function TopNavbar() {
  ...
  React.useEffect(() => {
    if (activeCategory && ['Category', 'Brand', 'Membership'].includes(activeCategory)) {
  ...
  return (
    <>
      {/* Backdrop for mega menus - OUTSIDE header */}
      {activeCategory && ['Category', 'Brand', 'Membership'].includes(activeCategory) && (
        <div 
      ...
      {/* Category navigation */}
      <div className="hidden lg:block border-t border-gray-200 bg-blue-600 category-dropdown relative">
        <div className={cn(theme.layout.container, "py-0 relative")}
        >
          <nav className="flex items-center justify-center space-x-6">
            {categories.map((category) => {
              // Define routes for specific categories
              const categoryRoutes: { [key: string]: string } = {
                'Buying Guide': '/buying-guide',
                'Freebies': '/freebies',
                'Best Seller': '/best-seller',
                'Events': '/events',
                'New Clinic Setup': '/new-clinic-setup'
              };
              ...
              <div key={category} className="relative">
                ...
                {/* Simple Dropdown */}
                {!route && activeCategory === category && !['Category','Brand','Membership'].includes(category) && categoryDropdown[category as keyof typeof categoryDropdown] && (
          ...
          {activeCategory === 'Category' && (
            <div className="absolute left-0 right-0 top-full mt-1 z-50 flex justify-center">
              <CategoryMegaMenu onClose={() => setActiveCategory(null)} />
            </div>
          )}
